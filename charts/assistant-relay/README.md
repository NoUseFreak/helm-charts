...
The following tables list the configurable parameters of the assistant-relay chart and their default values.
...
| image.repository | string | `"apipa169/assistant-relay"` |  |
| image.tag | string | `""` |  |
